...
const contentService = new content_service_1.ContentService(contentRepository, dailyPlanService);
const onboardingService = new onboarding_service_1.OnboardingService(dailyPlanService);
const practiceService = new practice_service_1.PracticeService(practiceRepository);
...
exports.app.use("/api", (0, routes_1.buildRouter)(contentController, audioController, authController, conversationController, reviewController, onboardingController, dailyPlanController, aiController, practiceController));
