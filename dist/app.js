...
const userGoal_repository_1 = require("./repositories/userGoal.repository");
...
const learningState_service_1 = require("./services/learningState.service");
const dailyAiPlanner_service_1 = require("./services/dailyAiPlanner.service");
const aiActivityGeneration_service_1 = require("./services/aiActivityGeneration.service");
...
const learningStateService = new learningState_service_1.LearningStateService();
const dailyAiPlannerService = new dailyAiPlanner_service_1.DailyAiPlannerService(openAiService);
...
const contentService = new content_service_1.ContentService(contentRepository, dailyPlanService, settingsRepository, aiRepository, practiceRepository, progressService, userGoalRepository, learningStateService, dailyAiPlannerService);
const profilePlanService = new profilePlan_service_1.ProfilePlanService(dailyPlanService, userGoalRepository);
const practiceService = new practice_service_1.PracticeService(practiceRepository, dailyPlanService, progressService);
...
const activityGenerationService = new aiActivityGeneration_service_1.AiActivityGenerationService(dailyPlanService, openAiService);
const dailyPlanController = new dailyPlan_controller_1.DailyPlanController(dailyPlanService, activityGenerationService);
